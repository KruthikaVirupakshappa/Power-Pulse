      ...
      begin;
    merge into "USER_DB_LYNX"."SNAPSHOT"."EIA_RTO_HOURLY_SNAPSHOT" as DBT_INTERNAL_DEST
    using "USER_DB_LYNX"."SNAPSHOT"."EIA_RTO_HOURLY_SNAPSHOT__dbt_tmp" as DBT_INTERNAL_SOURCE
